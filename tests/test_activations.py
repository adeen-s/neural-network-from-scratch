...
class TestActivations(unittest.TestCase):
    ...
    def test_relu_backward(self):
        ...
        grad_input = relu.backward(grad_output, learning_rate=0.01)
    ...
    def test_sigmoid_backward(self):
        ...
        grad_input = sigmoid.backward(grad_output, learning_rate=0.01)
    ...
    def test_tanh_backward(self):
        ...
        grad_input = tanh.backward(grad_output, learning_rate=0.01)
    ...
    def test_gradient_shapes(self):
        ...
        for activation in activations:
            ...
            grad_input = activation.backward(grad_output, learning_rate=0.01)
